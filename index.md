...
> 每新增一份报告，必须在本文件对应表格登记一行；状态：`draft` / `in-review` / `published`。
...
| 日期 | 主题 | 赛道 | 报告 | 状态 |
|---|---|---|---|---|
| — | — | — | 暂无。从 `templates/comparison-report.md` 开始 | — |

## 赛道全景

| 日期 | 赛道 | 报告 | 状态 |
|---|---|---|---|
| — | — | 暂无。从 `templates/landscape-report.md` 开始 | — |

## 趋势观察

| 月份 | 主题 | 报告 | 状态 |
|---|---|---|---|
| — | — | 暂无。从 `templates/trend-report.md` 开始 | — |

## 短笔记

| 日期 | 主题 | 笔记 | 状态 |
|---|---|---|---|
| — | — | 暂无。命名：`notes/YYYY-MM-DD-<slug>.md` | — |
